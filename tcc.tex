...
\newpage
\input{1_introducao}
\input{2.1_conceitos_gerais_data_warehouse}
\input{2.2_conceitos_gerais_pentaho}
\input{2.3_conceitos_gerais_mineracao_de_dados.tex}
\input{2.3.1_conceitos_gerais_crisp.tex}
\input{2.3.2_conceitos_gerais_weka.tex}
\input{3_metodologia.tex}
\input{4_estudo_de_caso.tex}
\input{5_conclusoes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Referências 
